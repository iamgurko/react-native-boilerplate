...
const TitleWrapper = styled(View)`
  ...
  margin-vertical: ${({ theme }) => theme.metrics.getHeightFromDP('12%')}px;
`;
...
const MAX_FONT_SIZE = appStyles.metrics.getWidthFromDP('5.5%');
const MIN_FONT_SIZE = appStyles.metrics.getWidthFromDP('3.5%');
